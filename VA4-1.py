...
if pages == 'Home':
    ...
    st.markdown("Hieronder wordt een grafiek weergegeven met data wereldwijd over de unemployment rate."), st.plotly_chart(fig, use_container_width=True)
    st.markdown("Hieronder wordt een barplot weergegeven met een overzicht van de 10 hoogste unemployment rate landen wereldwijd."), st.pyplot(fig1) 
    st.markdown("Hieronder wordt een grafiek weergegeven met een overzicht van de 10 laagste unemployment rate landen wereldwijd."), st.pyplot(fig3)
elif pages == 'Einde':
