...
if pages == 'Home':
    ...
    st.plotly_chart(fig, use_container_width=True), st.pyplot(fig1)#, st.plotly_chart(fig1, use_container_width=True)#, st.plotly_chart(fig3, use_container_width=True)
elif pages == 'Einde':
